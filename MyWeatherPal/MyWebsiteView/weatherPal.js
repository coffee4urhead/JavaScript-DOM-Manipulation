...
async function updateInfo(city = null) {
    ...
    if( typeOfWeather === "Clouds" ){
        imageOfWeather.src = "../images for website/images for card/cloudy.svg";
    }else if( typeOfWeather === "Clear" ) {
        imageOfWeather.src = "../images for website/images for card/clear-day.svg";
    }else if ( typeOfWeather === "Rain" ) {
        imageOfWeather.src = "../images for website/images for card/rain.svg";
    }else if ( typeOfWeather === "Drizzle" ) {
        imageOfWeather.src = "../images for website/images for card/drizzle.svg";
    }else if ( typeOfWeather === "Mist" ) {
        imageOfWeather.src = "../images for website/images for card/mist.svg";
    }else if ( typeOfWeather === "Snow" ) {
        imageOfWeather.src = "../images for website/images for card/snow.svg";
    } else {
